...
import deco2800.thomas.tasks.combat.VolcanoFireballAttackTask;
...
public class VolcanoFireballSkill extends AbstractSkill {
    ...
    public VolcanoFireballSkill(Peon parent) {
        if (parent == null) {
    ...
    protected AbstractTask getTask(float targetX, float targetY) {
        ...
        return new VolcanoFireballAttackTask(entity, targetX, targetY, damage, SPEED, LIFETIME);
    }
}
