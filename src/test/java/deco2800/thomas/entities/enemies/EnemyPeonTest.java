...
public class EnemyPeonTest extends BaseGDXTest {
    ...
    public void testConstructor() {
        Orc enemy = new Orc(EnemyIndex.Variation.SWAMP, 1, 1);
        assertEquals(enemy.getSpeed(), 1f, 0.01);
    }

    @Test
    public void testEnemyName() {
        EnemyPeon enemy = new Goblin(EnemyIndex.Variation.SWAMP, 1, 1);
        assertEquals(enemy.getObjectName(), "Swamp Goblin");
    }

    @Test
    public void testGetMaxHealth() {
        EnemyPeon enemy =  new Orc(EnemyIndex.Variation.SWAMP, 100, 1);
    ...
    public void testGetCurrentHealth() {
        EnemyPeon enemy =  new Orc(EnemyIndex.Variation.SWAMP, 100, 10);
