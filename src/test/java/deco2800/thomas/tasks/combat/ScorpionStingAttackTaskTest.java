...
public class ScorpionStingAttackTaskTest extends BaseGDXTest {
    ...
    /**
     * Verifies that the scorpion sting is spawned correctly.
     */
    @Test
    public void sandTornadoSpawnTest() {
        ScorpionStingAttackTask task = new ScorpionStingAttackTask(combatEntity, 0,0,10,0.25f,10);
        task.spawn(0,0,10,10,10,0.25f,10,EntityFaction.EVIL);
        verify(abstractWorld, times(1)).addEntity(any(StingProjectile.class));
    }
}