...
public class SandTornadoAttackTaskTest extends BaseGDXTest {
    ...
    /**
     * Verifies that the sandTornado is spawned correctly.
     */
    @Test
    public void sandTornadoSpawnTest() {
        SandTornadoAttackTask task = new SandTornadoAttackTask(combatEntity, 0,0,10,0.25f,10);
        task.spawn(0,0,10,10,10,0.25f,10,EntityFaction.EVIL);
        verify(abstractWorld, times(1)).addEntity(any(SandTornado.class));
    }
}